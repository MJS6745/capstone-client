...
var config = {
  apiOrigins: {
    production: 'https://protected-ocean-97576.herokuapp.com',
...
var showPlayersTemplate = __webpack_require__(22);
var singlePlayerTemplate = __webpack_require__(39);
var strategyTemplate = __webpack_require__(40);

var addPlayerSuccess = function addPlayerSuccess(data) {
  ...
  var showPlayersHtml = singlePlayerTemplate({ player: data.player });
  $('#playerlist').append(showPlayersHtml);
};

var addPlayerFailure = function addPlayerFailure(error) {
...
var addSearchPlayerSuccess = function addSearchPlayerSuccess(data) {
  // console.log('Search player success invoked. Data is', data)
  var modalName = '#addSearchPlayerModal' + data.player.jersey_number;
...
var addSearchPlayerFailure = function addSearchPlayerFailure(error) {
  // console.log('addSearchPlayerFailure, error is', error)
};

var updateListSuccess = function updateListSuccess(data) {
  // console.log('Update list success invoked. Data is', data)
  $('#playerlist').empty();
  for (var i = 0; i < data.players.length; i++) {
    data.players[i].teamlogo = assignLogo(data.players[i].team);
  }
  var showPlayersHtml = showPlayersTemplate({ players: data.players });
...
var getStrategySuccess = function getStrategySuccess(data) {
  $('#keeper-list').empty();
  ...
  var keeperHtml = strategyTemplate({ players: keeperList });
  $('#keeper-list').append(keeperHtml);
  var rightBackHtml = strategyTemplate({ players: rightBackList });
  $('#rightback-list').append(rightBackHtml);
  var leftBackHtml = strategyTemplate({ players: leftBackList });
  $('#leftback-list').append(leftBackHtml);
  var centreBackHtml = strategyTemplate({ players: centreBackList });
  $('#centreback-list-a').append(centreBackHtml);
  $('#centreback-list-b').append(centreBackHtml);
  var rightWingHtml = strategyTemplate({ players: rightWingList });
  $('#rightwing-list').append(rightWingHtml);
  var leftWingHtml = strategyTemplate({ players: leftWingList });
  $('#leftwing-list').append(leftWingHtml);
  var midfieldHtml = strategyTemplate({ players: midfieldList });
  $('#midfield-list-a').append(midfieldHtml);
  $('#midfield-list-b').append(midfieldHtml);
  var strikerHtml = strategyTemplate({ players: strikerList });
  $('#striker-list-a').append(strikerHtml);
  $('#striker-list-b').append(strikerHtml);
};

var assignLogo = function assignLogo(team) {
  var logo = '';
...
var deletePlayerFailure = function deletePlayerFailure(error) {
...
module.exports = {
  ...
  addPlayerFailure: addPlayerFailure,
  getPlayersSuccess: getPlayersSuccess,
  getPlayersFailure: getPlayersFailure,
  editPlayerSuccess: editPlayerSuccess,
  editPlayerFailure: editPlayerFailure,
  deletePlayerSuccess: deletePlayerSuccess,
  deletePlayerFailure: deletePlayerFailure,
  clearPlayers: clearPlayers,
  updateListSuccess: updateListSuccess,
  addSearchPlayerSuccess: addSearchPlayerSuccess,
  addSearchPlayerFailure: addSearchPlayerFailure,
  assignLogo: assignLogo,
  getStrategySuccess: getStrategySuccess
};
...
var standingsTemplate = __webpack_require__(41);
var playerListTemplate = __webpack_require__(42);
var playerUi = __webpack_require__(7);

var getStandingsSuccess = function getStandingsSuccess(data) {
  ...
  var standingsHtml = standingsTemplate({ clubs: data.standing });
  // console.log('standingsHtml is', standingsHtml)
  $('#standingstable').append(standingsHtml);
};

var getStandingsFailure = function getStandingsFailure(error) {
...
var httpsLogo = function httpsLogo(teamUrl) {
...
var getPlayerSuccess = function getPlayerSuccess(data) {
  ...
  var searchHtml = playerListTemplate({ players: data.players });
  $('#search-results').append(searchHtml);
};

var setTeamName = function setTeamName(data) {
  // Need to check the ID at the end of the URL for self and assign the team name based on that
  var teamUrl = data._links.team.href;
...
var getPlayerFailure = function getPlayerFailure(error) {
  clearSearch();
...
module.exports = {
  getStandingsSuccess: getStandingsSuccess,
  getStandingsFailure: getStandingsFailure,
  getPlayerSuccess: getPlayerSuccess,
  getPlayerFailure: getPlayerFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var editPlayer = function editPlayer(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log('Edit player form data is ', data)
  api.editPlayer(data).then(ui.editPlayerSuccess)
  // New code for updating list of players
  .then($('#editPlayersMessageModal').on('hidden.bs.modal', updatePlayerList)).catch(ui.editPlayerFailure);
};

var addPlayer = function addPlayer(event) {
  // console.log('addPlayer event invoked')
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log('Target data is ', data)
  api.addPlayer(data).then(ui.addPlayerSuccess).catch(ui.addPlayerFailure);
};

var addSearchPlayer = function addSearchPlayer(event) {
  // console.log('addSearchPlayer event invoked')
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log('Target data is ', data)
  api.addPlayer(data).then(ui.addSearchPlayerSuccess).catch(ui.addSearchPlayerFailure);
};

var updatePlayerList = function updatePlayerList() {
  api.getPlayers().then(ui.updateListSuccess);
};

var getPlayers = function getPlayers(event) {
  // console.log('Get players event invoked')
  event.preventDefault();
  // console.log('Target is', event.target)
  api.getPlayers().then(ui.getPlayersSuccess).catch(ui.getPlayersFailure);
};

var getStrategy = function getStrategy(event) {
  event.preventDefault();
  api.getPlayers().then(ui.getStrategySuccess).catch(ui.getStrategyFailure);
};

var deletePlayer = function deletePlayer(event) {
  // console.log('Release player event invoked')
  event.preventDefault();
  // console.log('Target is', event.target)
  var data = getFormFields(event.target);
  var modalName = '#deletePlayerModal' + data.player.id;
  api.deletePlayer(data).then($(modalName).modal('hide').on('hidden.bs.modal', ui.clearPlayers)).then(ui.deletePlayerSuccess)
  // New code for updating list of players
  .then($('#deletePlayerMessageModal').on('hidden.bs.modal', updatePlayerList)).catch(ui.deletePlayerFailure);
};
...
var getStandings = function getStandings() {
  ...
  var token = '49272f6236284aee99353cc125b5a69a';
  return $.ajax({
...
var getPlayerList = function getPlayerList(data) {
...
var playerEvents = __webpack_require__(11);
var footdataApi = __webpack_require__(13);
var footdataUi = __webpack_require__(8);
var footdataEvents = __webpack_require__(43);
...
// housed here
var getStandings = function getStandings() {
  footdataApi.getStandings().then(footdataUi.getStandingsSuccess).catch(footdataUi.getStandingsFailure);
};
...
var onSignUp = function onSignUp(event) {
  ...
  // console.log('Data is ', data)
  if (data.credentials.email !== '' && data.credentials.password !== '') {
    api.signUp(data).then(api.signUpSignIn).then(ui.signUpSuccess).catch(ui.signUpFailure);
  } else {
    ui.signUpFailure();
  }
};
...
var signUpSignIn = function signUpSignIn(data) {
  return $.ajax({
...
var editPlayer = function editPlayer(data) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<!-- Start player card style -->\n<!-- <section> -->\n  <!-- <div class=\"container py-3\"> -->\n    <div class=\"card\">\n      <div class=\"row playercard\">\n        <div class=\"col-sm-3\">\n            <img src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.teamlogo : stack1), depth0))
    + "\" class=\"team-logo\">\n          </div>\n          <div class=\"col-sm-5\">\n            <div class=\"card-block\">\n              <h4 class=\"card-title\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</h4>\n              <ul>\n                <li>Number: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.jersey_number : stack1), depth0))
    + "</li>\n                <li>Club: "
    ...
    + "</li>\n              </ul>\n              <button type=\"button\" class=\"btn btn-info\" data-toggle=\"modal\" data-target=\"#editPlayerModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-resourceid=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit Player</button>\n              <button type=\"button\" class=\"btn btn-info\" data-toggle=\"modal\" data-target=\"#deletePlayerModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-resourceid=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Release Player</button>\n            </div>\n          </div>\n\n        </div>\n      </div>\n    </div>\n  <!-- </div> -->\n<!-- </section> -->\n<!-- End player card style -->\n  <!-- Edit modal start -->\n  <div class=\"modal fade\" id=\"editPlayerModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <h3 class=\"modal-title\" id=\"exampleModalLabel\">Edit My Player</h3>\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n        </div>\n        <div class=\"modal-body\">\n          <form class=\"editPlayerForm\">\n            <input type=\"hidden\" name=player[id] value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <div class=\"form-group\">\n              <label for=\"name-input\">Name</label>\n              <input class=\"form-control\" type=\"text\" name=\"player[name]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\" id=\"name-input\" required>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"jersey-number-input\">Jersey Number</label>\n              <input class=\"form-control\" type=\"number\" min=\"0\" max=\"99\" name=\"player[jersey_number]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.jersey_number : stack1), depth0))
    + "\" id=\"jersey-number-input\" required>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"team-input\">Club</label>\n              <input class=\"form-control\" type=\"text\" name=\"player[team]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.team : stack1), depth0))
    + "\" id=\"team-input\" required>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"position-input\">Position</label>\n              <input class=\"form-control\" type=\"text\" name=\"player[position]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.position : stack1), depth0))
    + "\" id=\"position-input\" required>\n            </div>\n            <button type=\"submit\" class=\"btn btn-info\">Confirm Changes</button>\n          </form>\n        </div>\n        <div class=\"modal-footer\">\n          <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n        </div>\n      </div>\n    </div>\n  </div>\n  <!-- Edit modal end -->\n\n  <!-- Delete confirmation modal start -->\n  <div class=\"modal fade\" id=\"deletePlayerModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <h3 class=\"modal-title\" id=\"exampleModalLabel\">Are you sure you want to delete "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + " from your list?</h3>\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n        </div>\n        <div class=\"modal-body\">\n          <form class=\"deletePlayerForm\">\n            <input type=\"hidden\" name=player[id] value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <button type=\"submit\" class=\"btn btn-info\">Yes</button>\n          </form>\n        </div>\n        <div class=\"modal-footer\">\n          <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n        </div>\n      </div>\n    </div>\n  </div>\n  <!-- Delete confirmation modal end -->\n  <!-- Modal for release player end -->\n</div>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- Start player card style -->\n<!-- <section> -->\n  <!-- <div class=\"container py-3\"> -->\n    <div class=\"card\">\n      <div class=\"row playercard\">\n        <div class=\"col-sm-3\">\n            <img src=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.teamlogo : stack1), depth0))
    + "\" class=\"team-logo\">\n          </div>\n          <div class=\"col-sm-5\">\n            <div class=\"card-block\">\n              <h4 class=\"card-title\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h4>\n              <ul>\n                <li>Number: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.jersey_number : stack1), depth0))
    + "</li>\n                <li>Club: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.team : stack1), depth0))
    + "</li>\n                <li>Position: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.position : stack1), depth0))
    + "</li>\n              </ul>\n              <button type=\"button\" class=\"btn btn-info\" data-toggle=\"modal\" data-target=\"#editPlayerModal"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" data-resourceid=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">Edit Player</button>\n              <button type=\"button\" class=\"btn btn-info\" data-toggle=\"modal\" data-target=\"#deletePlayerModal"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.id : stack1), depth0))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<tr>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.position : stack1), depth0))
    + " <img src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.crestURI : stack1), depth0))
    + "\" width=\"24\" height=\"24\"> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.teamName : stack1), depth0))
    + "</td>\n  <!-- <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.position : stack1), depth0))
    + " <input type=\"image\" height=\"24\" width=\"24\" src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.crestURI : stack1), depth0))
    + "\" id=\"teamlink\"/> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.teamName : stack1), depth0))
    + "</td> -->\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.playedGames : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.wins : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.draws : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.losses : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.goals : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.goalsAgainst : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.goalDifference : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.points : stack1), depth0))
    + "</td>\n</tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.clubs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"card w-30\">\n  <div class=\"card-block\">\n    <h3 class=\"card-title\">"
    ...
    + " <img src=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.teamlogo : stack1), depth0))
    + "\" height=\"40\" width=\"40\"></h3>\n    <ul class=\"list-group player-search-result\">\n      <li class=\"list-group-item\">Age: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.age : stack1), depth0))
    + "</li>\n      <li class=\"list-group-item\">Position: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.position : stack1), depth0))
    + "</li>\n      <li class=\"list-group-item\">Number: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.jerseyNumber : stack1), depth0))
    + "</li>\n      <li class=\"list-group-item\">National Squad: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.nationality : stack1), depth0))
    + "</li>\n    </ul>\n    <!-- Button for each player start -->\n    <button type=\"button\" class=\"btn btn-info\" data-toggle=\"modal\" data-target=\"#addSearchPlayerModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.jerseyNumber : stack1), depth0))
    + "\" id=\"addSearchPlayerButton\">\n      Sign Player\n    </button>\n    <!-- Button for each player end -->\n    <!-- Modal for each player start -->\n    <div class=\"modal fade\" id=\"addSearchPlayerModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.jerseyNumber : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n      <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h3 class=\"modal-title\" id=\"exampleModalLabel\">Add a Player</h3>\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n          </div>\n          <div class=\"modal-body\">\n            <form class=\"addPlayerSearchForm\">\n              <div class=\"form-group\">\n                <label for=\"name-input\">Name</label>\n                <input class=\"form-control\" type=\"text\" name=\"player[name]\" id=\"name-input\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\" required>\n              </div>\n              <div class=\"form-group\">\n                <label for=\"jersey-number-input\">Jersey Number</label>\n                <input class=\"form-control\" type=\"number\" min=\"0\" max=\"99\" name=\"player[jersey_number]\" id=\"jersey-number-input\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.jerseyNumber : stack1), depth0))
    + "\" required>\n              </div>\n              <div class=\"form-group\">\n                <label for=\"team-input\">Club</label>\n                <input class=\"form-control\" type=\"text\" name=\"player[team]\" id=\"team-input\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cleanTeamName : stack1), depth0))
    + "\" required>\n              </div>\n              <div class=\"form-group\">\n                <label for=\"position-input\">Position</label>\n                <input class=\"form-control\" type=\"text\" name=\"player[position]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.position : stack1), depth0))
    + "\" id=\"position-input\" required>\n              </div>\n              <button type=\"submit\" class=\"btn btn-info\">Sign Player</button>\n            </form>\n          </div>\n          <div class=\"modal-footer\">\n            <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n          </div>\n        </div>\n      </div>\n    </div>\n    <!-- Modal for each player end -->\n  </div>\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
var getTeamInfo = function getTeamInfo(event) {
  event.preventDefault();
  // console.log('Event target is', event.target)
  var data = getFormFields(event.target);
  // console.log('Data is', data)
  api.getPlayerList(data).then(ui.getPlayerSuccess).catch(ui.getPlayerFailure);
};
